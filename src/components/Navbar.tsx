...
const Navbar = () => {
  ...
  return (
    <nav className={`p-2 md:p-4 top-0 z-50 ${isAuthRoute ? "bg-background" : "bg-surface shadow-md border-none dark:border-b-1 sticky"}`}>
      <div className="flex items-center md:justify-between">
        ...
        {/* Right side: user icon/auth buttons */}
          <div className="flex justify-end items-center w-1/3 md:w-auto">
            ...
            <div className={`hidden items-center space-x-4 md:flex ${isAuthRoute ? "invisible" : ""}`}>
              <Link
                href="/auth/login"
